            ...
            @if(count($products) > 0)
                <div class="row">
                    @foreach($products as $product)
                        ...
                        <div class="col-md-3">
                            <div class="product">
                                <img src="http://localhost/{{ htmlspecialchars($images[0]) }}" alt="Main Image" id="mainImage_{{ $product->id }}" />
                                <div class="thumbnails-container">
                                    ...
                                    <div class="thumbnails" id="thumbnails_{{ $product->id }}">
                                        @foreach($images as $image)
                                            <img src="http://localhost/{{ htmlspecialchars($image) }}" alt="Thumbnail" class="thumbnail" onclick="changeMainImage('{{ htmlspecialchars($image) }}', '{{ $product->id }}')" />
                                        @endforeach
                                    </div>
